package com.app.planium.constants;
...
public interface Constants {
    ...
    public static final String YOUTUBE_API_KEY = "AIzaaSyAz8TvzJtaYkvsNNR2sQz2T9atmQZOyc3otK";
    ...
    public static final String BILLING_KEY = "";

    public static final String WEB_SITE = "https://planium.sinplan.org/";  //web site url address

    // Client ID For identify the application | Must be the same with CLIENT_ID from server config: db.inc.php

    public static final String CLIENT_ID = "1234";  // Correct example: 12567 | Incorrect example: 0987

    public static final String API_DOMAIN = "https://planium.sinplan.org/";  // url address to which the application sends requests || 10.0.2.2
    ...
    public static final String METHOD_GET_PLANS = API_DOMAIN + "api/" + API_VERSION + "/method/profile.getPlanes" + API_FILE_EXTENSION;
    public static final String METHOD_GET_PLANS2 = API_DOMAIN + "api/" + API_VERSION + "/method/plan.getPlanes" + API_FILE_EXTENSION;
    ...
    public static final String METHOD_PLAN_CREATE = API_DOMAIN + "api/" + API_VERSION + "/method/plan.create" + API_FILE_EXTENSION;
    public static final String METHOD_PLAN_GET = API_DOMAIN + "api/" + API_VERSION + "/method/plan.get" + API_FILE_EXTENSION;
    ...
    public static final String METHOD_PLAN_SAVE_SETTINGS = API_DOMAIN + "api/" + API_VERSION + "/method/plan.saveSettings" + API_FILE_EXTENSION;
    ...
    public static final String METHOD_PLAN_GET_WALL = API_DOMAIN + "api/" + API_VERSION + "/method/plan.getWall" + API_FILE_EXTENSION;
    ...
    public static final String METHOD_ITEMS_PLAN_NEW = API_DOMAIN + "api/" + API_VERSION + "/method/items.plannew" + API_FILE_EXTENSION;
    ...
    public static final String METHOD_PLAN_UPLOAD_IMAGE = API_DOMAIN + "api/" + API_VERSION + "/method/plan.uploadImg" + API_FILE_EXTENSION;

    // added for version 5.0
    public static final String METHOD_STRIPE = API_DOMAIN + "api/" + API_VERSION + "/method/stripe" + API_FILE_EXTENSION;
    ...
    public static final String METHOD_PLANCOMMENTS_NEW = API_DOMAIN + "api/" + API_VERSION + "/method/commentsplan.new" + API_FILE_EXTENSION;

    public static final String METHOD_LIKES_LIKE = API_DOMAIN + "api/" + API_VERSION + "/method/likes.like" + API_FILE_EXTENSION;
    public static final String METHOD_LIKES_LIKE_PLAN = API_DOMAIN + "api/" + API_VERSION + "/method/likes.like" + API_FILE_EXTENSION;
