...
import com.app.planium.view.LineItemDecoration;
...
public class PlanNearbyFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), mRecyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Plan u = (Plan) itemsList.get(position);
                                ...
                                if (response.has("items")) {
                                    ...
                                    if (arrayLength > 0) {
                                        ...
                                        for (int i = 0; i < usersArray.length(); i++) {
                                            ...
                                            itemsList.add(plan);
                                            //Log.e("nombre: ", plan.getUsername());
                                            //Log.e("distancia: ", String.valueOf(plan.getDistance()));
                                        }
                                    }
                                }
