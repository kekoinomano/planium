...
public class CheckoutActivityJava extends ActivityBase {
    /**
     *
    ...
    Toolbar mToolbar;
    private static final String BACKEND_URL = "https://planium.sinplan.org/public/";

    private OkHttpClient httpClient = new OkHttpClient();
    private String paymentIntentClientSecret;
    private Stripe stripe;
    public String cantidad, nombre;
    TextView mCantidad, mNombre;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNombre = (TextView) findViewById(R.id.labelCredits);
        mCantidad = (TextView) findViewById(R.id.cantidadid);
        ...
        mCantidad.setText(cantidad + " €");
        mNombre.setText(nombre);
        Log.e("Precio", String.valueOf(cantidad));
    }
