...
public class PlanSettingsFragment extends Fragment implements Constants {

    public static final int RESULT_OK = -1;

    private ProgressDialog pDialog;

    private String name, location, website, description, mFinalidad = "Todo";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_plan_settings, container, false);
    ...
    public void saveSettings() {
        ...
        CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_PLAN_SAVE_SETTINGS, null,
