package com.app.planium.adapter;
...
import com.app.planium.GroupActivity;
import com.app.planium.PlanActivity;
import com.app.planium.HashtagsActivity;
import com.app.planium.LikersActivity;
import com.app.planium.MediaViewerActivity;
import com.app.planium.ProfileActivity;
import com.app.planium.R;
import com.app.planium.VideoViewActivity;
import com.app.planium.ViewItemActivity;
import com.app.planium.ViewYouTubeVideoActivity;
import com.app.planium.app.App;
import com.app.planium.constants.Constants;
import com.app.planium.model.Comment;
import com.app.planium.model.Item;
import com.app.planium.model.MediaItem;
import com.app.planium.util.Api;
import com.app.planium.util.ApiPlan;
import com.app.planium.util.CustomRequest;
import com.app.planium.util.TagClick;
import com.app.planium.util.TagSelectingTextview;
import com.app.planium.view.ResizableImageView;
...
public class AdvancedItemPlanListAdapter extends RecyclerView.Adapter<AdvancedItemPlanListAdapter.ViewHolder> implements Constants, TagClick {
    ...
    public AdvancedItemPlanListAdapter(Context ctx, List<Item> items) {
...
//        }
        ...
        holder.mItemLikeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_LIKES_LIKE_PLAN, null,
                    ...
                    case R.id.action_remove: {
                        ...
                        alertDialog.setPositiveButton(context.getText(R.string.action_yes), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                ApiPlan api = new ApiPlan(context);
