...
if (!empty($_POST)) {
    ...
    $result = $posts->addplan($postMode, $postText, $postImg, $rePostId, $groupId, $postArea, $postCountry, $postCity, $postLat, $postLng, $videoImgUrl, $videoUrl, 0, $feeling, $accountId);
