...
if (!empty($_POST)) {
    ...
    $finalidad = helper::clearText($finalidad);
    $finalidad = helper::escapeText($finalidad);
    ...
    $plan = new group($dbo);
    $plan->setRequestFrom($accountId);

    $result = $plan->create2($group_name, $group_fullname, $group_category, $group_desc, $group_site, $group_location, $year, $month, $day, $group_allow_posts, $group_allow_comments, $finalidad);
