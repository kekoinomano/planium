...
class post extends db_connect
{
    ...
    public function addplan($mode, $postText, $postImage = "", $rePostId = 0, $groupId = 0, $postArea = "", $postCountry = "", $postCity = "", $postLat = "0.00000", $postLng = "0.00000", $videoImgUrl = "", $videoUrl = "", $postType = 0, $feeling = 0, $userId= 0)
    {
    ...
    public function infoplan($postId)
    {
        $result = array(
            "error" => true,
            "error_code" => ERROR_UNKNOWN
