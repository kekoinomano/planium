<?php
    ...
    $TEXT['main-page-prompt-app'] = "My Social Network is where you go, so you can create posts and chat with your friends anytime, anywhere. Stay in touch with your friends with the mobile application My Social Network. Available for Android.";
...
//    $TEXT['action-join'] = "Регистрация";
    ...
    // $TEXT['fb-linking'] = "Підключитися до Facebook";
    ...
    $TEXT['page-privacy'] = "Privacy policy"; //Политика конфиденциальности
    ...
    $TEXT['action-access-mode-all'] = "For all"; //Для всех
    $TEXT['action-access-mode-friends'] = "Friends"; //Друзья